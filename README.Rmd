...
Users of the statistical software Stata can use the [Stata module "divratio"](https://econpapers.repec.org/software/bocbocode/S459169.htm) available from the SSC repository to implement many of these same tools.
